        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://cdn.sanity.io https://www.google-analytics.com https://tiles.openfreemap.org https://*.basemaps.cartocdn.com https://images.unsplash.com https://*.images.unsplash.com",
              "media-src 'self' https://xeno-canto.org https://*.xeno-canto.org",
              "connect-src 'self' https://*.sanity.io https://*.sanity.run https://vercel.live https://www.google-analytics.com https://region1.google-analytics.com https://www.googletagmanager.com https://api.ebird.org https://tiles.openfreemap.org https://*.basemaps.cartocdn.com https://xeno-canto.org https://*.xeno-canto.org",
